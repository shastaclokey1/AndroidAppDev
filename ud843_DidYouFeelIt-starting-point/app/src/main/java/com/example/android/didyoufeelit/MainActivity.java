...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        // Perform the async HTTP request for earthquake data and process the response.
        EarthquakeDataFetcher fetcher = new EarthquakeDataFetcher();
        fetcher.execute(USGS_REQUEST_URL);
    }

    //private async task class that runs our earthquake data fetching in the background so not to slow down the UI
    private class EarthquakeDataFetcher extends AsyncTask<String, Void, Event>
    {
