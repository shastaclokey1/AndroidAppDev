...
public class EarthquakeActivity extends AppCompatActivity implements LoaderCallbacks<List<Earthquake>>
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //set the empty view state of our text view
    ...
    {
        //getting the shared preferences manager so we can know how to build the query uri
        ...
        String maxQuakesShown = sharedPrefs.getString(
                getString(R.string.settings_max_quakes_shown_key),
                getString(R.string.settings_max_quakes_shown_default));
        ...
        uriBuilder.appendQueryParameter("limit", maxQuakesShown);
